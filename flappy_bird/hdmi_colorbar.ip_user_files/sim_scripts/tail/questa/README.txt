...
#
# Generated by export_simulation on Sat May 07 10:24:31 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './tail.sh' script.
...
./tail.sh -noclean_files

For more information on the script, please type './tail.sh -help'.
