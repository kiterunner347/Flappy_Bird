...
#
# Generated by export_simulation on Sat May 07 17:14:54 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './over.sh' script.
...
./over.sh -noclean_files

For more information on the script, please type './over.sh -help'.
