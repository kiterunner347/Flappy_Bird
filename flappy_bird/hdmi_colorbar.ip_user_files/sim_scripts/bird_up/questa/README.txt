...
#
# Generated by export_simulation on Sat May 07 15:06:18 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './bird_up.sh' script.

./bird_up.sh -reset_run
...
./bird_up.sh -noclean_files

For more information on the script, please type './bird_up.sh -help'.
